...
async def run_test():
    ...
    try:
        ...
        try:
            ...
            raise AssertionError('Test case failed: The user did not receive a JWT token or was not redirected to the user dashboard after login, indicating authentication failure.')
