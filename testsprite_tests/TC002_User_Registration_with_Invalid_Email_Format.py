...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to registration page by clicking 'Get Started' button.
        ...
        # -> Enter invalid email format and valid password, then submit the form.
        frame = context.pages[-1]
        # Enter full name
        ...
        frame = context.pages[-1]
        # Click Sign Up button to submit the registration form with invalid email
        ...
        frame = context.pages[-1]
        await expect(frame.locator('text=Join Local League Cricket today').first).to_be_visible(timeout=30000)
