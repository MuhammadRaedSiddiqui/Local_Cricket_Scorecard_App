...
async def run_test():
    ...
    try:
        ...
        # Click the 'Sign In' button to go to login page
        elem = frame.locator('xpath=html/body/main/section/div[4]/div/div[2]/a[2]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Input registered email 'test@gmail.com' and password 'test@123-123' into the respective fields.
        frame = context.pages[-1]
        ...
        frame = context.pages[-1]
        await expect(frame.locator('text=Welcome back, Ahmed! 👋').first).to_be_visible(timeout=30000)
