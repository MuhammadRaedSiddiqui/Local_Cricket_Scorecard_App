...
async def run_test():
    ...
    try:
        ...
        # -> Click on 'Get Started' button to navigate to registration page.
        ...
        # -> Clear the email field and enter a new unique email address, then resubmit the registration form.
        frame = context.pages[-1]
        # Clear the email field to enter a new unique email
        elem = frame.locator('xpath=html/body/div[2]/div/form/div[2]/div/input').nth(0)
        ...
        elem = frame.locator('xpath=html/body/div[2]/div/form/div[2]/div/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('unique_test_user_12345@gmail.com')
        

        frame = context.pages[-1]
        # Click the 'Sign Up' button to submit the registration form with new email
        elem = frame.locator('xpath=html/body/div[2]/div/form/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
